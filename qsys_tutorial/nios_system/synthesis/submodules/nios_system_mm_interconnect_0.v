...
module nios_system_mm_interconnect_0 (
	...
	wire   [14:0] rsp_mux_src_channel;                                                                   // rsp_mux:src_channel -> nios2_processor_data_master_agent:rp_channel
	...
	wire   [14:0] rsp_mux_001_src_channel;                                                               // rsp_mux_001:src_channel -> nios2_processor_instruction_master_agent:rp_channel
	...
	wire   [14:0] cmd_mux_001_src_channel;                                                               // cmd_mux_001:src_channel -> performance_counter_0_control_slave_agent:cp_channel
	...
	wire   [14:0] cmd_mux_002_src_channel;                                                               // cmd_mux_002:src_channel -> nios2_processor_jtag_debug_module_agent:cp_channel
	...
	wire   [14:0] cmd_mux_004_src_channel;                                                               // cmd_mux_004:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_005_src_channel;                                                               // cmd_mux_005:src_channel -> switches_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_006_src_channel;                                                               // cmd_mux_006:src_channel -> KEYs_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_007_src_data;                                                                  // cmd_mux_007:src_data -> Hex1_s1_agent:cp_data
	...
	wire  [105:0] cmd_mux_008_src_data;                                                                  // cmd_mux_008:src_data -> Hex2_s1_agent:cp_data
	...
	wire   [14:0] cmd_mux_011_src_channel;                                                               // cmd_mux_011:src_channel -> Hex3_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_012_src_channel;                                                               // cmd_mux_012:src_channel -> Hex4_s1_agent:cp_channel
	...
	wire   [14:0] cmd_mux_013_src_channel;                                                               // cmd_mux_013:src_channel -> Hex5_s1_agent:cp_channel
	...
	wire  [106:0] hex6_s1_agent_rf_source_data;                                                          // Hex6_s1_agent:rf_source_data -> Hex6_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] hex6_s1_agent_rsp_fifo_out_data;                                                       // Hex6_s1_agent_rsp_fifo:out_data -> Hex6_s1_agent:rf_sink_data
	...
	wire          cmd_mux_014_src_valid;                                                                 // cmd_mux_014:src_valid -> Hex6_s1_agent:cp_valid
	wire  [105:0] cmd_mux_014_src_data;                                                                  // cmd_mux_014:src_data -> Hex6_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                                 // Hex6_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [14:0] cmd_mux_014_src_channel;                                                               // cmd_mux_014:src_channel -> Hex6_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                         // cmd_mux_014:src_startofpacket -> Hex6_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                           // cmd_mux_014:src_endofpacket -> Hex6_s1_agent:cp_endofpacket
	...
	wire  [105:0] switches_s1_agent_rp_data;                                                             // switches_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [105:0] hex1_s1_agent_rp_data;                                                                 // Hex1_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [105:0] hex2_s1_agent_rp_data;                                                                 // Hex2_s1_agent:rp_data -> router_010:sink_data
	...
	wire          hex6_s1_agent_rp_valid;                                                                // Hex6_s1_agent:rp_valid -> router_016:sink_valid
	wire  [105:0] hex6_s1_agent_rp_data;                                                                 // Hex6_s1_agent:rp_data -> router_016:sink_data
	wire          hex6_s1_agent_rp_ready;                                                                // router_016:sink_ready -> Hex6_s1_agent:rp_ready
	wire          hex6_s1_agent_rp_startofpacket;                                                        // Hex6_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          hex6_s1_agent_rp_endofpacket;                                                          // Hex6_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire   [14:0] cmd_demux_001_src2_channel;                                                            // cmd_demux_001:src2_channel -> cmd_mux_010:sink1_channel
	...
	wire   [14:0] rsp_demux_010_src1_channel;                                                            // rsp_demux_010:src1_channel -> rsp_mux_001:sink2_channel
	...
	wire   [14:0] router_012_src_channel;                                                                // router_012:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire  [105:0] sdram_s1_rsp_width_adapter_src_data;                                                   // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_010:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                                  // rsp_demux_010:sink_ready -> sdram_s1_rsp_width_adapter:out_ready
	wire   [14:0] sdram_s1_rsp_width_adapter_src_channel;                                                // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_010:sink_channel
	...
	wire  [105:0] cmd_mux_010_src_data;                                                                  // cmd_mux_010:src_data -> sdram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_010_src_ready;                                                                 // sdram_s1_cmd_width_adapter:in_ready -> cmd_mux_010:src_ready
	wire   [14:0] cmd_mux_010_src_channel;                                                               // cmd_mux_010:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire          hex6_s1_agent_rdata_fifo_src_valid;                                                    // Hex6_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] hex6_s1_agent_rdata_fifo_src_data;                                                     // Hex6_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          hex6_s1_agent_rdata_fifo_src_ready;                                                    // avalon_st_adapter_014:in_0_ready -> Hex6_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                     // avalon_st_adapter_014:out_0_valid -> Hex6_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                      // avalon_st_adapter_014:out_0_data -> Hex6_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                     // Hex6_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                     // avalon_st_adapter_014:out_0_error -> Hex6_s1_agent:rdata_fifo_sink_error
